...
/**
 * Service Interface for managing {@link com.example.user.domain.AppUser}.
 */
public interface AppUserService {
    ...
    /**
     * Get the appUser by cin.
     *
     * @param cin the cin of the entity.
     * @return the entity.
     */
    Optional<AppUserDTO> findByCin(String cin); // Added method
}