package com.example.request.security.jwt;

import static com.example.request.security.AuthoritiesConstants.ADMIN;
import static com.example.request.security.SecurityUtils.AUTHORITIES_CLAIM;
import static com.example.request.security.SecurityUtils.JWT_ALGORITHM;
