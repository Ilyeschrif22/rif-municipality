...
export const AppUserDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/app-user${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.appUser.delete.question">
        <Translate contentKey="gatewayApp.appUser.delete.question" interpolate={{ id: appUserEntity.id }}>
