...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUNICIPALITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MUNICIPALITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MUNICIPALITY actions', async () => {
      const arg = { id: 20885 };
    ...
    it('dispatches UPDATE_MUNICIPALITY actions', async () => {
      const arg = { id: 20885 };
    ...
    it('dispatches PARTIAL_UPDATE_MUNICIPALITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MUNICIPALITY actions', async () => {
      const arg = 42666;
