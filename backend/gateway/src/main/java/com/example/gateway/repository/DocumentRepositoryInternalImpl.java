...
import com.example.gateway.repository.rowmapper.DocumentRowMapper;
...
/**
 * Spring Data R2DBC custom repository implementation for the Document entity.
 */
@SuppressWarnings("unused")
class DocumentRepositoryInternalImpl extends SimpleR2dbcRepository<Document, Long> implements DocumentRepositoryInternal {
    ...
    public DocumentRepositoryInternalImpl(
        ...
        super(
            new MappingRelationalEntityInformation(converter.getMappingContext().getRequiredPersistentEntity(Document.class)),
            entityOperations,
            converter
        );
    ...
    RowsFetchSpec<Document> createQuery(Pageable pageable, Condition whereClause) {
        ...
        String select = entityManager.createSelect(selectFrom, Document.class, pageable, whereClause);
