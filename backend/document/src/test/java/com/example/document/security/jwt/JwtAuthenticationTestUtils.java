package com.example.document.security.jwt;

import static com.example.document.security.AuthoritiesConstants.ADMIN;
import static com.example.document.security.SecurityUtils.AUTHORITIES_CLAIM;
import static com.example.document.security.SecurityUtils.JWT_ALGORITHM;
